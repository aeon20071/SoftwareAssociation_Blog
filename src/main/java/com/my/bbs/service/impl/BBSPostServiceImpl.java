...
public class BBSPostServiceImpl implements BBSPostService {
    ...
    public List<BBSPost> getAllPost() {
        return bbsPostMapper.getAllPost();
    }

    @Override
    public int changePostState(int state,Long post_id) {
        return bbsPostMapper.changePostState(state,post_id);
    }

    @Override
    public int addtitle(BBSTitle title) {
        return bbsPostMapper.addtitle(title);
    }

    @Override
    public int deltitle(Integer tid) {
        return bbsPostMapper.deltitle(tid);
    }

    @Override
    public List<BBSTitle> getAllTitle() {
        return bbsPostMapper.getAllTitle();
    }
}
